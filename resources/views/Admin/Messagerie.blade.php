    ...
    <div class="home-content container-fluid  px-4 pt-4">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                ...
                <ul class="inbox-menu">
                    <li class="{{ Request::is('/Messages/Recu1') ? 'active' : '' }}">
                        <a href="/Messages/Recu1"><i class="fas fa-download"></i> Messages reçus <span
                                class="mail-count">({{ count($messages) }})</span></a>
                    </li>
                    <li class="{{ Request::is('/Messages/Envoyées1') ? 'active' : '' }}">
                        <a href="/Messages/Envoyées1"><i class="fas fa-paper-plane"></i> Messages envoyés </a>
                    </li>
    ...
    <script>
        $(document).ready(function() {
            $('.compose-btn').click(function() {
                var url = "{{ url('/compose-email1') }}"; // Generate the URL for the route
